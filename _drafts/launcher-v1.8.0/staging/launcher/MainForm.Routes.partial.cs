...
namespace IFQuantLauncher
{
    internal sealed partial class MainForm
    {
        ...
        private int UiSmokeBody(string sandbox)
        {
            ...
            // The grid deliberately carries a typed value across a panel change
            // when the marker token is the same, and panel LEFT's KRT5 box was
            // filled above. Clear it, or this checks the wrong thing.
            thresholdBoxes["KRT5"].Text = "";
