...
`IFQuantLauncher-v1.9.3.exe` is a Windows Forms front end for the analysis
...
## What the four routes replaced (introduced v1.8.0; current source v1.9.3)
...
- `IFQuantLauncher-v1.9.3.exe`
- `IFQuantLauncher-v1.9.3.sha256.txt`
